<?php 
    session_start();
    include('includes/main-admin.php');
...
?>
     ...
     <?php if(isset($_SESSION['message'])) 
                {?>
                    <div class="message" style="background-color: #6ABB80; color: #000; padding: 10px; border: 1px solid #6ABB80; border-radius: 4px; margin-bottom: 10px;">
                    <?= $_SESSION['message']; ?>.<strong>Welcome! Please Refresh To Start</strong>
                    </div>
               <?php
